        ...
        try {
            ...
            while ((line = reader.readLine()) != null) {
                if (line.startsWith("CapEff:")) {
                    ...
                    // BigInteger instead of Long.parseUnsignedLong: that overload is API 26 and
                    // minSdk is 24, where the missing method surfaces as NoSuchMethodError, which
                    // the surrounding catch(Exception) would not contain.
                    long caps = new java.math.BigInteger(value, 16).longValue();
